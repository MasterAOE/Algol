...
<<<<<<< HEAD
            ...
            (x2-x1)**2=R2**2-(yo+ma.sqrt(R1**2-(x2-xo)**2)-y1)**2
            (x2-x1)**2=R2**2-((y0-y1)**2+2(y0-y1)*ma.sqrt(R1**2-(x2-x0)**2)+(R1**2-(x2-x0)**2))
            ...
            '''
            x2=(4*x1**3-4*x1*x1*x0-ma.sqrt((((-4*x1**3+4*x1*x1*x0-4*x1*y0*y0+8*x1*y0*y1+4*x1*x0*x0-4*x1*y1*y1+4*x1*R2*R2-4*x1*R1*R1-4*y0*y0*x0+8*y0*x0*y1-4*x0**3-4*x0*y1*y1-4*x0*R2*R2+4*x0*R1*R1)**2)-4*(4*x1*x1-8*x1*x0+4*y0*y0-8*y0*y1+4*x0*x0+4*y1*y1)*(x1**4+2*x1*x1*y0*y0-4*x1*x1*y0*y1-2*x1*x1*x0*x0+2*x1*x1*y1*y1-2*x1*x1*R2*R2+2*x1*x1*R1*R1+y0**4-4*(y0**3)*y1+2*y0*y0*x0*x0+6*y0*y0*y1*y1-2*y0*y0*R2*R2-2*y0*y0*R1*R1-4*y0*x0*x0*y1-4*y0*(y1**3)+4*y0*y1*R2*R2+4*y0*y1*R1*R1+(x0**4)+2*x0*x0*y1*y1+2*x0*x0*R2*R2-2*x0*x0*R1*R1+(y1**4)-2*y1*y1*R2*R2-2*y1*y1*R1*R1+(R2**4)-2*R2*R2*R1*R1+R1**4)))+4*x1*y0-8*x1*y0*y1-4*x1*x0*x0+4*x1*y1*y1-4*x1*R2*R2+4*x1*R1*R1+4*y0*y0*x0-8*y0*x0*y1+4*x0**3+4*x0*y1*y1+4*x0*R2*R2-4*x0*R1*R1)/(2*(4*x1*x1-8*x1*x0+4*y0*y0-8*y0*y1+4*x0*x0+4*y1*y1))
>>>>>>> d17a6becc4fdb0fd3a80d186d89337e26d422f0d
            l1=ma.fabs(x2-x0)
            l2=ma.fabs(x2-x1)
            if l1<=R1 and l2<=R2:
